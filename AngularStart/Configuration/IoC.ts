...
//            application.constant('_', _);
        ...
        {
            $routeProvider
                .when("/home", { controller: "Pages.HomeController", templateUrl: "Pages/Home/HomeView.html" })
                .when("/samples", { controller: "Pages.SamplesController", templateUrl: "Pages/Samples/SamplesView.html" })
                .when("/ui", { controller: "Pages.UiBootstrapController", templateUrl: "Pages/UiBootstrap/UiBootstrapView.html" })
                .when("/links", { controller: "Pages.LinksController", templateUrl: "Pages/Links/LinksView.html" })
                .when("/about", { controller: "Pages.AboutController", templateUrl: "Pages/About/AboutView.html" })
